...
{
    public partial class RolePlayCharacterForm : Form
    {
        ...
        RolePlayCharacter.RolePlayCharacterAsset _rpc;
        ...
        public void SaveRPC(object sender, EventArgs e)
        {
            string saveFileName = "";
            bool newSaveFile = true;
            ...
            catch (Exception exception)
            {
                ...
                MessageBox.Show(new Messages().ERRORSAVINGFILE().ShowMessage(), new Messages().ERRORDIALOGTITLE().ShowMessage(), MessageBoxButtons.OK,
