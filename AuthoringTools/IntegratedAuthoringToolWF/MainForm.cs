...
namespace IntegratedAuthoringToolWF
{
    public partial class MainForm : Form
    {
      ...
      //  private string tooltip = "";
        private int step;
        private int maxTutorialSteps = 5;
        private int maxExperiencedSteps = 2;
        ...
        private void initAssistant()
        {
           ...
           // assistantStatetoAction = new Dictionary<Tuple<int, int>, System.Action<object, EventArgs>>();
            ...
            // 0 Basic Expert level, No Reactions
            assistantDescription.Add(new Tuple<int, int>(1, 0),
                "The Simulator component can be used to test the current state of the scenario \n" +
               "It is possible to play as any of the characters and check their internal state at any moment");


            // 0 Basic Expert level, No Reactions
            assistantDescription.Add(new Tuple<int, int>(1, 1),
                "For each different actions there can exist different emotional reactions. \n" +
 ...
 /*           else if (authorExpertiseLevel == 2)
            ...
            if (authorExpertiseLevel == 0)
            {
                switch (step)
                {
                    case 0:
                        ...
                        assistantTopicGroupBox.Text = "FAtiMA Characters";
                        break;
                    case 1:
                        button1.Text = "Add Beliefs";
                        assistantTopicGroupBox.Text = "Agent's Internal State";
                        break;
                    case 2:
                        button1.Text = "Add Actions";
                        assistantTopicGroupBox.Text = "Emotional Decison Making";
                        break;
                    case 3:
                        button1.Text = "Add Dialogue";
                        assistantTopicGroupBox.Text = "Dialogues";
                        break;
                    case 4:
                        button1.Text = "Add Appraisal Rule";
                        assistantTopicGroupBox.Text = "Emotional Appraisal";
                        break;
                }
            ...
            else if (authorExpertiseLevel == 1)
            {
                switch (step)
                {
                    case 0:
                        ...
                        assistantTopicGroupBox.Text = "Simulator";
                        break;

                    case 1:
                        button1.Text = "Add Emotional Reaction to Action Rule";
                        assistantTopicGroupBox.Text = "Emotional Appraisal";
                        break;
                }
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (authorExpertiseLevel == 0)
            {
                switch (step)
                {
                    case 0:  // No characters
                        HighlightButton(buttonAddCharacter);
            ...
            else if (authorExpertiseLevel == 1)
            {
                switch (step)
                {
                    case 0:  // Advise using the simulator
                        this.tabControlIAT.SelectedIndex = 4;
                        HighlightButton(buttonStart);
                        break;

                    case 1:  // No Emotional Appraisal Rules compared to Action Rules
                        this.tabControlIAT.SelectedIndex = 1;
                        this.tabControlAssetEditor.SelectedIndex = 1;
        ...
        private void nextPicture_Click(object sender, EventArgs e)
        {
            ...
            {
                if (this.step < maxExperiencedSteps - 1)
                    this.step += 1;
                else this.step = 0;
            }
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            ...
            else if (authorExpertiseLevel == 1)
            {
                if (this.step > 0)
                    this.step -= 1;
                else this.step = maxExperiencedSteps - 1;
            }
