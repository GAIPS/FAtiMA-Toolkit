...
{
    public partial class MultimodalEmotionDetection : Form
    {
        private Form1 FacialEmotionRecognitionForm;
        private MultimodalEmotionDetectionAsset MultimodalEmotionDetectionAsset { get; set; }
        ...
        public MultimodalEmotionDetection()
        {
            InitializeComponent();

            this.MultimodalEmotionDetectionAsset = new MultimodalEmotionDetectionAsset();
            ...
            this.MultimodalEmotionDetectionAsset.AddAffectRecognitionAsset(this.EDARecognitionAsset, 1.0f);
            this.MultimodalEmotionDetectionAsset.AddAffectRecognitionAsset(this.TextEmotionRecognitionAsset, 1.0f);
            this.MultimodalEmotionDetectionAsset.AddAffectRecognitionAsset(this.SpeechEmotionRecognitionAsset, 1.0f);
            this.MultimodalEmotionDetectionAsset.AddAffectRecognitionAsset(this.FacialEmotionRecognitionAsset, 1.0f);

            this.FusedAffectiveInformation = new BindingListView<AffectiveInformation>(this.MultimodalEmotionDetectionAsset.GetSample().ToList());
            ...
            this.MultimodalEmotionDetectionAsset.Policy = new MaxPolicy();

            this.KalmanFusionPolicy = new KalmanFilterFusionPolicy(this.MultimodalEmotionDetectionAsset.Classifiers);
        ...
        {
            this.MultimodalEmotionDetectionAsset.UpdateSamples();

            this.FusedAffectiveInformation.DataSource = this.MultimodalEmotionDetectionAsset.GetSample().ToList();
        ...
        private void cboxFusionPolicy_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                this.MultimodalEmotionDetectionAsset.Policy = new WeightedFusionPolicy();
            }
            else
            {
                this.MultimodalEmotionDetectionAsset.Policy = this.KalmanFusionPolicy;
            }
        }
