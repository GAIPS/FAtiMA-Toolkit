...
namespace EmotionalAppraisalTutorial
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var rule = new AppraisalRuleDTO { EventType = AMConsts.ACTION_START, Subject = "*", Action = "Kick", Target = "SELF", Desirability = -5f, Praiseworthiness = -3f };
            ...
            Console.WriteLine("\nAfter appraising  '" + kickEvent + "'\nWith the appraisal rule '"
                    + AppraisalRule.BuildEventName(rule) + " Desirability: "+rule.Desirability+ " Praiseworthiness: " + rule.Praiseworthiness +  "'");
